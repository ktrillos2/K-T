...
export default function CustomCursor() {
  ...
  return (
    <>
      ...
      <div
        ref={dotRef}
        className="hidden lg:block fixed top-0 left-0 pointer-events-none z-[11000] rounded-full mix-blend-difference will-change-transform"
        style={{
          width: isHover ? 60 : 8,
          height: isHover ? 60 : 8,
      ...
      <div
        ref={ringRef}
        className="hidden lg:block fixed top-0 left-0 pointer-events-none z-[11000] rounded-full border border-white/40 mix-blend-difference will-change-transform"
        style={{
          width: 32,
          height: 32,
