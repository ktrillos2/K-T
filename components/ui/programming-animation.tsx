        ...
        >
            ...
            >
                ...
                {drops.map((drop, i) => (
                    <motion.div
                        key={i}
                        className="absolute top-0 text-[10px] font-mono leading-none text-white/30 writing-vertical"
                        style={{ left: `${drop.x}%` }}
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20" style={{ transform: "translateZ(50px)" }}>
                    ...
                    >
                        ...
                        <div className="absolute inset-0 border-2 border-dashed border-white/40 rounded-full animate-[spin_20s_linear_infinite]" />
                        ...
                        {/* Inner Core Energy */}
                        <div className="absolute inset-8 bg-white/20 blur-xl rounded-full animate-pulse" />
                        ...
                        {/* Scanning Radar */}
                        <div className="absolute inset-0 rounded-full bg-gradient-to-t from-transparent via-white/10 to-transparent opacity-30 animate-spin transition-transform duration-[3s]" />
                    </motion.div>
                </div>
                ...
                {symbols.map((item, i) => {
                    ...
                    return (
                        <motion.div
                            key={i}
                            className="absolute p-3 rounded-xl bg-black/40 border border-white/10 backdrop-blur-md shadow-lg z-30 group-hover:border-white/30 transition-colors duration-500"
                            style={{
                                left: `${item.x}%`,
                                top: `${item.y}%`,
                        ...
                        >
                            <Icon className="w-5 h-5 text-white/80 group-hover:text-white transition-colors" strokeWidth={1.5} />
                        </motion.div>
                    )
                })}
