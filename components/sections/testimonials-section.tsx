            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                ...
                <div className="mt-16 flex justify-center">
                    <motion.button
                        ...
                        className="group relative px-8 py-4 bg-white text-black font-mono font-bold rounded-xl border-2 border-white hover:bg-neutral-200 transition-all duration-300 flex items-center gap-3 overflow-hidden outline-none"
                    >
