...
export default function InternationalSection() {
    ...
    // Random markers logic (added to match request for random points on map)
    const randomMarkers = React.useMemo(() => {
        ...
        <section className="relative py-10 !pt-0 lg:py-5 bg-black overflow-hidden flex flex-col items-center justify-center">
            ...
            <div className="w-full max-w-7xl mx-auto px-4 md:px-8 relative z-20 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                ...
                <div className="text-center lg:text-left order-1 pt-8 lg:pt-0">
                    ...
                    >
                        <h2 className="text-3xl md:text-5xl font-bold text-white font-title mb-6 lg:mb-8">
                            {/* @ts-ignore */}
                            {dictionary.international?.title || "Sin Fronteras"}
                        </h2>
                        <p className="text-base md:text-lg font-normal text-neutral-400 max-w-lg mx-auto lg:mx-0 font-mono leading-relaxed mb-8">
                            {/* @ts-ignore */}
                            {dictionary.international?.description || "Aunque nuestra base está en Colombia, nuestro código viaja por todo el mundo. Trabajamos con clientes en toda Latinoamérica y Estados Unidos, ofreciendo estándares de calidad globales."}
                        </p>
                ...
                {/* Globe: Centered on Mobile (Order 2), Right on Desktop (Order 2) */}
