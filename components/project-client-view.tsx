                        ...
                        <div className="lg:col-span-4 space-y-12">
                            ...
                            <div>
                                ...
                                <a
                                    ...
                                    className="relative overflow-hidden inline-flex items-center gap-2 px-6 py-3 bg-white text-black font-mono font-bold rounded-xl border-2 border-white hover:bg-neutral-200 transition-all duration-300 group"
                                    onMouseEnter={() => setCursorVariant("hover")}
                                    onMouseLeave={() => setCursorVariant("default")}
                                >
