...
export const generalFaqs: FaqItem[] = [
  {
    ...
    answer:
      "No existe una empresa de desarrollo web que sea la mejor opción para todos los proyectos. Para elegir un proveedor se deben evaluar criterios como experiencia demostrable, portafolio público, propiedad total del código entregado, tecnologías utilizadas, procesos de mantenimiento post-lanzamiento, costos transparentes y casos de estudio verificables. K&T Code se especializa en desarrollo web a medida con arquitectura moderna y código nativo, enfocándose en rendimiento, SEO técnico y arquitecturas escalables para empresas en Colombia y Latinoamérica.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Una tienda virtual con pasarelas de pago colombianas e inventario en K&T Code inicia desde $1.300.000 COP para planes Ecommerce Starter y desde $2.000.000 COP para plataformas Headless Ecommerce de alto rendimiento. Todos los planes incluyen catálogo autogestionable, pasarelas locales (Wompi, PayU, Bold, PSE, Nequi), cálculo de envíos y panel administrativo sin comisiones sobre ventas.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Un desarrollo web completo en K&T Code incluye: diseño UI/UX exclusivo en Figma (móvil y escritorio), programación en código nativo modular, optimización de Core Web Vitals, estructuración semántica SEO con Schema JSON-LD, integración de WhatsApp y formularios de contacto, certificado SSL y entrega del repositorio de código.",
  },
  {
    question: "¿Necesito hosting?",
    answer:
      "Sí, toda página web requiere un lugar donde alojar sus archivos. Sin embargo, las arquitecturas web modernas reemplazan el hosting compartido tradicional lento por redes CDN globales serverless (Vercel / Cloudflare Edge), logrando tiempos de respuesta globales inferiores a 1 segundo y eliminando costos de servidores sobrecargados.",
  },
  {
