...
export const servicePages: Record<string, ServicePageData> = {
  "landing-pages": {
    ...
    metaDescription:
      "Desarrollo de landing pages de alta conversión en Colombia. Formularios inteligentes, carga veloz optimizada para Core Web Vitals, integración con WhatsApp Business y medición de campañas.",
    eyebrow: "// Páginas de Aterrizaje y Conversión Directa",
    summary:
      "Diseñamos y desarrollamos landing pages de alto rendimiento para empresas y campañas publicitarias en Colombia y clientes del exterior. Desarrolladas con arquitectura web moderna, nuestras páginas destacan por su óptima velocidad de carga, formularios optimizados para captación de clientes y conexión directa a WhatsApp Business y analítica publicitaria.",
    serviceType: "High-converting landing page development Colombia",
    showTechStack: true,
    ...
    benefits: [
      { title: "Carga de Alta Velocidad", description: "Arquitectura ligera estática diseñada para minimizar los tiempos de espera y reducir el rebote de visitantes." },
    ...
    includes: [
      ...
      "Desarrollo frontend modular con Tailwind CSS",
    ...
    process: [
      ...
      { title: "Desarrollo Frontend", description: "Programamos componentes modulares, rápidos y accesibles con animaciones sutiles y micro-interacciones." },
    ...
    faqs: [
      { question: "¿Cuánto cuesta desarrollar una landing page en K&T Code?", answer: "Nuestros planes inician desde $450.000 COP para empresas en Colombia o desde $200 USD para clientes en el exterior. El valor incluye diseño a medida, desarrollo optimizado, adaptación móvil, conexión a WhatsApp y hosting seguro en CDN." },
      ...
      { question: "¿Por qué es mejor una landing page a medida que una en WordPress o Wix?", answer: "Los constructores visuales convencionales suelen acumular scripts y dependencias que pueden elevar el tiempo de carga a más de 3 o 4 segundos en redes móviles. Con código propio a medida la página se compila de forma ligera y estática, ofreciendo una experiencia inmediata que retiene a los usuarios que llegan desde tus anuncios." },
    ],
    relatedArticles: [
  ...
  "desarrollo-web-a-medida": {
    ...
    metaDescription:
      "Desarrollo web a medida en Colombia. Sitios de alto rendimiento, optimización de Core Web Vitals, arquitectura headless y SEO técnico estructurado.",
    eyebrow: "// Ingeniería Web y Arquitectura de Software",
    summary:
      "K&T Code diseña y desarrolla plataformas web a medida utilizando arquitectura moderna y código nativo. Implementamos arquitecturas modernas orientadas a optimizar los Core Web Vitals, la seguridad y la indexación orgánica para empresas en Colombia y Latinoamérica.",
    serviceType: "Custom web development",
    showTechStack: true,
    showPerformanceComparison: true,
    benefits: [
      { title: "Optimización Core Web Vitals", description: "Arquitectura moderna orientada a cumplir los umbrales recomendados por Google en LCP, CLS e INP." },
      ...
      { title: "Seguridad y Escalabilidad", description: "Arquitectura modular sin dependencias vulnerables de plugins. Código limpio y probado, Server Actions y despliegue en CDN global." },
    ],
    includes: [
      "Auditoría técnica de arquitectura e intención de búsqueda",
      "Diseño UI/UX a medida en Figma (versión móvil y escritorio)",
      "Desarrollo frontend modular de alto rendimiento",
    ...
    process: [
      ...
      { title: "Desarrollo Frontend", description: "Programamos componentes modulares, limpios y optimizados con Server Components y estilos modernos." },
    ...
    faqs: [
      ...
      { question: "¿La página web desarrollada a medida será administrable?", answer: "Sí. Integramos paneles CMS Headless modernos (como Sanity, Supabase o paneles a medida) para que tu equipo pueda actualizar textos, blogs, imágenes y productos sin tocar una sola línea de código." },
  ...
  "tiendas-virtuales": {
    ...
    metaDescription:
      "Desarrollo de tiendas virtuales headless en Colombia con WooCommerce y Shopify. Catálogo, administración de pedidos, pasarelas Wompi, Bold, PayU, PSE, envíos y capacitación.",
    eyebrow: "// Comercio Electrónico de Alto Rendimiento",
    summary:
      "Construimos tiendas virtuales y plataformas de comercio electrónico headless en Colombia y el exterior, combinando un frontend ultra veloz con motores robustos como WooCommerce o Shopify en el backend. Entregamos catálogos autogestionables, panel administrativo para inventario y pedidos, pasarelas de pago colombianas, cálculo de envíos y capacitación completa a tu equipo.",
    serviceType: "Headless E-commerce development WooCommerce Shopify Colombia",
    showTechStack: true,
    showPerformanceComparison: true,
    whatWeDevelop: [
      { title: "Tiendas Virtuales Headless", description: "Frontend ultrarrápido conectado a WooCommerce o Shopify mediante APIs seguras para que las compras móviles ocurran sin esperas." },
    ...
    includes: [
      "Arquitectura headless (Frontend desacoplado + Backend WooCommerce/Shopify/Custom)",
    ...
    process: [
      ...
      { title: "Integración Headless & APIs", description: "Conectamos el frontend desacoplado con el backend y las pasarelas de pago mediante APIs seguras." },
    ...
    faqs: [
      { question: "¿Qué es una tienda virtual Headless y qué ventajas tiene?", answer: "En una tienda Headless, el frontend (lo que ve el cliente) está desarrollado con tecnología moderna de forma desacoplada del backend (donde gestionas el inventario, como WooCommerce o Shopify). Esto permite que la tienda cargue de forma instantánea (<0.5 segundos), ofreciendo una experiencia idéntica a una aplicación nativa y multiplicando las conversiones." },
      { question: "¿Puedo mantener mi tienda WooCommerce existente y mejorar la velocidad con Headless?", answer: "Sí. Podemos conectar un frontend nuevo y ultra rápido a tu backend actual de WooCommerce mediante la REST API, conservando tus productos, clientes e historial de pedidos intactos." },
  ...
  "software-a-medida": {
    ...
    metaTitle: "Desarrollo de Software a Medida en Colombia | Paneles & SaaS",
    metaDescription:
      "Desarrollamos software web a medida, paneles administrativos, portales de clientes y plataformas SaaS con Supabase y PostgreSQL en Colombia.",
    eyebrow: "// Soluciones Digitales Corporativas",
    summary:
      "Automatizamos y digitalizamos las operaciones críticas de tu empresa mediante aplicaciones web y software a medida. Creamos paneles de administración, portales corporativos, plataformas SaaS y sistemas de gestión interna con arquitectura moderna, Supabase y bases de datos PostgreSQL.",
    serviceType: "Custom software web development SaaS",
    showTechStack: true,
    ...
    benefits: [
      ...
      { title: "Arquitectura Fullstack Moderna", description: "Desarrollo con Server Actions, endpoints seguros y bases de datos PostgreSQL de alto rendimiento." },
    ...
    includes: [
      ...
      "Desarrollo frontend interactivo y modular",
    ...
    process: [
      ...
      { title: "Desarrollo por Módulos (Sprints)", description: "Programamos entregables funcionales con revisiones periódicas del avance y base de datos optimizada." },
    ...
    faqs: [
      ...
      { question: "¿Qué tecnologías utilizan para el desarrollo de software web?", answer: "Utilizamos un stack moderno y probado en producción: arquitectura modular, Tailwind CSS, Supabase / PostgreSQL, Node.js y despliegues serverless de alta disponibilidad." },
  ...
  "diseno-web-corporativo": {
    ...
    metaDescription:
      "Diseñamos páginas web corporativas profesionales para empresas en Colombia. Diseño exclusivo, alta velocidad, enfoque en conversión B2B y posicionamiento SEO.",
    eyebrow: "// Presencia Digital y Autoridad de Marca",
    summary:
      "Tu página web es la carta de presentación de tu empresa ante clientes e inversores. Diseñamos sitios web corporativos modernos, rápidos y elegantes en Colombia, construidos con ingeniería de alto rendimiento para transmitir máxima confianza, comunicar tu propuesta de valor y captar clientes potenciales calificados.",
    serviceType: "Corporate website design Colombia",
    showTechStack: true,
    showPerformanceComparison: true,
    benefits: [
      ...
      { title: "Velocidad y Adaptación Móvil", description: "Carga instantánea en cualquier celular o conexión móvil gracias a la generación estática pre-optimizada." },
    ...
    includes: [
      ...
      "Desarrollo frontend con animaciones fluidas y micro-interacciones",
    ...
    process: [
      ...
      { title: "Programación Frontend", description: "Convertimos el diseño en código limpio y eficiente con animaciones sutiles y rendimiento de primer nivel." },
  ...
  "seo-tecnico": {
    ...
    metaDescription:
      "Auditoría y optimización de SEO técnico en Colombia. Mejoramos rastreo, indexación, optimización de Core Web Vitals y rendimiento Lighthouse, datos estructurados JSON-LD y arquitectura web moderna.",
    ...
    serviceType: "Technical SEO optimization Colombia",
    showTechStack: false,
    showPerformanceComparison: false,
    benefits: [
    ...
    idealFor: [
      ...
      "Aplicaciones web con problemas de renderizado o indexación en buscadores",
    ...
    faqs: [
      ...
      { question: "¿Pueden auditar sitios construidos en diferentes plataformas?", answer: "Sí. Auditamos sitios web en WordPress, Shopify, Webflow o código a medida, identificando las limitaciones técnicas y proponiendo la solución más eficiente." },
  ...
  "desarrollo-nextjs": {
    ...
    title: "Desarrollo Web de Alto Rendimiento en Colombia",
    shortTitle: "Desarrollo Alto Rendimiento",
    metaTitle: "Desarrollo Web de Alto Rendimiento en Colombia | Arquitectura Headless",
    metaDescription:
      "Desarrollo web especializado en arquitectura headless y alto rendimiento para empresas en Colombia. Optimización de Core Web Vitals y rendimiento Lighthouse, SaaS y e-commerce.",
    eyebrow: "// Ingeniería Web & Arquitectura Headless",
    summary:
      "K&T Code diseña sitios corporativos, plataformas web y e-commerce utilizando arquitectura headless de alto rendimiento para empresas que necesitan velocidad, escalabilidad e integraciones personalizadas.",
    serviceType: "High performance web development agency Colombia",
    showTechStack: true,
    showPerformanceComparison: true,
    whatWeDevelop: [
      ...
      { title: "Plataformas Web y Aplicaciones SaaS", description: "Sistemas fullstack con Server Actions, APIs seguras y bases de datos PostgreSQL / Supabase de alto rendimiento." },
    ...
    includes: [
      "Arquitectura de software y modelado de datos de alto rendimiento",
    ...
    process: [
      ...
      { title: "Desarrollo Frontend Modular", description: "Programamos componentes modulares con Tailwind CSS y Server Components." },
    ...
    faqs: [
      { question: "¿Qué ventajas técnicas ofrece esta arquitectura frente a sistemas monolíticos como WordPress?", answer: "El renderizado desde el servidor y la generación estática pre-optimizada logran tiempos de carga notablemente ágiles que favorecen la experiencia móvil y los Core Web Vitals. Además, reduce la superficie de ataque al desacoplar el frontend y minimizar la dependencia de plugins de terceros." },
      { question: "¿Qué empresas utilizan esta arquitectura a nivel mundial y en Colombia?", answer: "Empresas líderes como TikTok, Twitch, Hulu, Nike, Target y las startups más exitosas de Latinoamérica utilizan arquitecturas desacopladas y Server Components por su rendimiento incomparable y escalabilidad." },
      { question: "¿Puedo editar los textos e imágenes de mi web sin saber programar?", answer: "Sí. Integramos paneles CMS Headless modernos (como Sanity, Supabase o paneles a medida) para que cualquier persona del equipo pueda editar contenidos, crear artículos y subir imágenes de forma intuitiva." },
      { question: "¿Cuánto cuesta un proyecto de desarrollo de alto rendimiento en Colombia?", answer: "Nuestros proyectos inician desde $2.500.000 COP para sitios corporativos de alto rendimiento, escalando según la complejidad de integraciones, base de datos y módulos interactivos." },
      { question: "¿Cuál es el tiempo promedio de entrega?", answer: "Un sitio web corporativo de alto rendimiento suele desarrollarse en 2 a 4 semanas. Plataformas complejas o aplicaciones SaaS requieren entre 4 a 8 semanas con entregables quincenales verificables." },
    ],
    relatedArticles: [
      { title: "Desarrollo a medida vs. plantillas: cómo elegir en 2026", href: "/blog/desarrollo-web-medida-vs-plantillas" },
      { title: "El costo oculto de una página web lenta", href: "/blog/costo-oculto-pagina-web-lenta" },
  ...
  "woocommerce-headless": {
    ...
    title: "Desarrollo WooCommerce Headless en Colombia",
    shortTitle: "WooCommerce Headless",
    metaTitle: "Desarrollo WooCommerce Headless en Colombia | Tiendas Virtuales de Alta Velocidad",
    metaDescription:
      "Agencia experta en WooCommerce Headless en Colombia. Acelera tu tienda online con checkout en < 1s, pasarelas Wompi, PayU, Bold y SEO de productos.",
    eyebrow: "// E-commerce Desacoplado de Alto Rendimiento",
    summary:
      "Transformamos tiendas WooCommerce lentas en plataformas headless de alta velocidad con frontend desacoplado. Conservas tu panel de productos y clientes de WooCommerce mientras tus usuarios disfrutan de una experiencia de compra instantánea compatible con pasarelas de pago colombianas.",
    serviceType: "Headless WooCommerce development Colombia",
    showTechStack: true,
    showPerformanceComparison: true,
    whatWeDevelop: [
      { title: "Frontend Desacoplado de Alta Velocidad", description: "Interfaz de catálogo ultra rápida que consulta tu base de datos WooCommerce mediante REST API o GraphQL." },
    ...
    includes: [
      ...
      "Desarrollo frontend a medida con arquitectura desacoplada y modular",
    ...
    process: [
      ...
      { title: "Desarrollo Frontend Desacoplado", description: "Programamos el storefront desacoplado conectando las APIs seguras de WooCommerce." },
    ...
    faqs: [
      { question: "¿Pierdo mis productos o pedidos actuales al migrar a WooCommerce Headless?", answer: "No. Tu base de datos de WooCommerce, historial de clientes, pedidos y configuración de productos se mantienen 100% intactos. Solo reemplazamos la capa visual por un frontend moderno y ultra veloz." },
