...
export const projects: Project[] = [
  {
    id: "repuestos-germana",
    slug: "repuestos-germana",
    title: "Repuestos Germana",
    titleEn: "Repuestos Germana",
    titleEs: "Repuestos Germana",
    client: "Repuestos Germana",
    industry: "Automotriz / Taller y Repuestos Alta Gama",
    country: "Colombia",
    city: "Bogotá",
    projectType: "Portal Web de Repuestos y Servicio Automotriz Especializado",
    ...
    descEs: "Portal web de alto rendimiento y estrategia de marketing digital para Repuestos Germana, taller y distribuidor nacional de repuestos de alta gama en Bogotá.",
    images: {
      hero: "/images/projects/repuestos.webp",
      mobile: "/images/projects/repuestos-mobile.webp",
    },
    liveUrl: "https://repuestosgermana.com",
    content: {
      challenge: "Repuestos Germana operaba previamente con una página web que presentaba serios problemas de lentitud en los tiempos de carga y un diseño desactualizado que no reflejaba la categoría ni la confianza requerida por dueños de vehículos de alta gama. Además, necesitaban un canal directo y efectivo para canalizar solicitudes de mantenimiento de taller en Bogotá y gestionar pedidos de repuestos para clientes de todo el territorio nacional.",
      solution: "Rediseñamos la experiencia integral de la marca con una interfaz moderna, limpia y responsive. Estructuramos un catálogo claro de repuestos y servicios de taller especializado, optimizamos la velocidad de respuesta en conexiones móviles y de escritorio para una navegación veloz, e implementamos un canal directo hacia asesores comerciales vía WhatsApp API junto a una estrategia de marketing digital continua.",
      seoFocus: "Taller alta gama Bogotá, repuestos autos alta gama Colombia, mantenimiento vehículos premium Bogotá, repuestos automotrices Bogotá venta nacional.",
      results: "Se logró una web notablemente rápida, fluida y con una presentación visual a la altura de las marcas premium que atienden. El flujo de cotizaciones para mantenimiento en Bogotá y pedidos de repuestos a nivel nacional se dinamizó, y actualmente el cliente continúa trabajando de la mano con nosotros en sus campañas y posicionamiento de marketing.",
    },
    metrics: {
      lighthouseBefore: "34/100",
      lighthouseAfter: "97/100",
      lcpBefore: "5.1 s",
      lcp: "630 ms",
      loadTimeBefore: "5.1 s",
      loadTimeAfter: "0.63 s",
      conversionIncrease: "Flujo comercial activo a nivel nacional",
      catalogSize: "Líneas de Repuestos & Taller Alta Gama",
      pagesDeveloped: "6 páginas optimizadas",
      integrations: "WhatsApp Business API + Canal Cotizaciones Nacional + Estrategia Marketing Digital",
      keyAchievements: [
        "Superación del diseño previo obsoleto por una interfaz premium y moderna.",
        "Optimización de velocidad de carga rápida para usuarios móviles y desktop.",
        "Canalización de solicitudes para taller en Bogotá y venta de repuestos a nivel nacional.",
        "Acompañamiento y ejecución continua en temas de marketing digital.",
      ],
    },
  },
  {
