...
export default function RedesPage() {
    ...
    const socialLinks = [
        ...
        },
        {
            name: "TikTok",
            desc: "@kytcode",
            url: "https://www.tiktok.com/@kytcode",
            icon: TikTokIcon,
    ...
    return (
        <main className="min-h-screen bg-background pt-32 pb-24 px-4 sm:px-6 relative overflow-hidden">
                            ...
                            >
                                <Link href={`/projects/${project.slug}`} className="block group">
                                    <div className="relative aspect-[16/9] rounded-xl overflow-hidden mb-3 border border-border">
                                        <Image
                                            src={project.hero || project.images?.hero || '/images/placeholder.webp'}
                                            alt={project.title}
                                            fill
            ...
            <div className="text-center mt-16 text-xs text-muted-foreground font-mono flex justify-center">
                <Link href="https://www.kytcode.lat" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 hover:text-white transition-colors cursor-pointer whitespace-nowrap">
