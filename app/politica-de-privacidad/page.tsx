...
export const metadata: Metadata = {
    ...
    description: 'Conoce cómo K&T Code recopila, utiliza y protege los datos enviados mediante formularios, WhatsApp y otros canales de contacto.',
        ...
        <main className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                ...
                <footer className="mt-16 pt-8 border-t border-gray-200 dark:border-gray-800 text-sm text-gray-500 text-center">
                    ...
                    <p className="mt-2 text-primary font-medium hover:underline cursor-pointer flex justify-center w-full">
                        <a href="https://www.kytcode.lat" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 whitespace-nowrap">
