...
const industry = industryPages["ecommerce-b2b"]

export const metadata: Metadata = {
  title: industry.metaTitle,
  description: industry.metaDescription,
  keywords: [
    "desarrollo ecommerce b2b colombia",
    "portales mayoristas e-commerce",
    "tiendas virtuales b2b precios por volumen",
    "software pedidos distribuidores colombia",
    "K&T Code ecommerce B2B",
  ],
  alternates: {
...
export default function EcommerceB2BPage() {
  return (
    <>
