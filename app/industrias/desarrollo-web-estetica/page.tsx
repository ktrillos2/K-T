...
const industry = industryPages["desarrollo-web-estetica"]

export const metadata: Metadata = {
  title: industry.metaTitle,
  description: industry.metaDescription,
  keywords: [
    "desarrollo web estetica spas colombia",
    "paginas web centros de dermatologia bogota",
    "agendamiento citas spa belleza web",
    "galeria antes y despues tratamientos estetica",
    "K&T Code estetica y belleza",
  ],
  alternates: {
