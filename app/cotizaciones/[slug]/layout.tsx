...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `${data.subdomain ? `https://${data.subdomain}.kytcode.lat` : 'https://www.kytcode.lat'}/images/og-image.webp`,
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: `Cotización: ${data.clientName} | K&T Code`,
      description: seoDescription,
      images: [`${data.subdomain ? `https://${data.subdomain}.kytcode.lat` : 'https://www.kytcode.lat'}/images/og-image.webp`],
    },
  }
}
